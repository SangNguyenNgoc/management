...
public class AddDeviceState extends AbstractState implements State {

    public AddDeviceState(HomeController homeController) {
    ...
    public void renderView(VBox content) {
        try {
            ...
            controller.initAddDeviceButton();
    ...
    public void initButton(HBox leftToolbar, HBox rightToolbar) {
        ...
        openExcelButton.setOnAction(event -> handleImportExcel());
    ...
    private void handleImportExcel() {
        ...
        if (selectedFile != null) {
            String result = DeviceService.getInstance().saveFromExcel(selectedFile);
            if(result == null) {
