...
public class StatDeviceByTimeState extends AbstractState implements State {
    public StatDeviceByTimeState(HomeController homeController) {
    ...
    public void renderView(VBox content) {
        try {
            ...
            controller.initStatDeviceByTime();
    ...
    public void initButton(HBox leftToolbar, HBox rightToolbar) {
        ...
        penalizeButton.setOnMouseClicked(event -> homeController.initContent(new StatPenalizeState(homeController)));
