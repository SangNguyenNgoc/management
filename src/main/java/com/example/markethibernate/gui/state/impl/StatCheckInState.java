...
public class StatCheckInState extends AbstractState implements State {
    public StatCheckInState(HomeController homeController) {
    ...
    public void initButton(HBox leftToolbar, HBox rightToolbar) {
        ...
        checkInButton.setUnderline(true);
